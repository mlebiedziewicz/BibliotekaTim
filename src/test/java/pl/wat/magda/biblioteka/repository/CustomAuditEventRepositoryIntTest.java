...
import pl.wat.magda.biblioteka.config.audit.AuditEventConverter;
import pl.wat.magda.biblioteka.domain.PersistentAuditEvent;
...
import static pl.wat.magda.biblioteka.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

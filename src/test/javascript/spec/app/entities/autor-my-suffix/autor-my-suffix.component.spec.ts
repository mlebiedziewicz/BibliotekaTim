...
import { AutorMySuffixComponent } from 'app/entities/autor-my-suffix/autor-my-suffix.component';
...
describe('Component Tests', () => {
    describe('AutorMySuffix Management Component', () => {
        let comp: AutorMySuffixComponent;
        let fixture: ComponentFixture<AutorMySuffixComponent>;
        let service: AutorMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [BibliotekaTimTestModule],
                declarations: [AutorMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(AutorMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(AutorMySuffixComponent);

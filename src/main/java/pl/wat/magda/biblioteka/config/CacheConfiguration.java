package pl.wat.magda.biblioteka.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(pl.wat.magda.biblioteka.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(pl.wat.magda.biblioteka.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
